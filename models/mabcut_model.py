...
class MABCUTModel(BaseModel):
    """ This class implements MabCUT model.
    This code is inspired by CUT and CycleGAN.
    """

    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        """  Configures options specific for MabCUT """
        parser.add_argument('--MabCUT_mode', type=str, default="MabCUT", choices='MabCUT')
        ...
        # Set default parameters for MabCUT_model.
        if opt.MabCUT_mode.lower() == "mabcut":
            parser.set_defaults(nce_idt=True, lambda_NCE=2.0)
        else:
            raise ValueError(opt.MabCUT_mode)
